...
export default function LeadRow({ lead: l }: { lead: Lead }) {
  ...
  return (
    <tr style={{ borderBottom: `1px solid ${border}` }}>
      ...
      <td style={{ padding: '7px 10px', color: accent, fontFamily: 'DM Mono', fontSize: 10 }}>{l.nct_number || '—'}</td>
      ...
      <td style={{ padding: '7px 10px', color: t2, fontSize: 10 }}>{l.recruitment_status || '—'}</td>
