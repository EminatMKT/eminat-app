...
// Fade en los bordes para insinuar el scroll horizontal sin scrollbar grotesca.
const fade = 'linear-gradient(to right, transparent 0, black 14px, black calc(100% - 14px), transparent 100%)'
