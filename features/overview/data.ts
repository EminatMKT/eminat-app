...
export const BRANDS: Brand[] = [
  ...
  { key: 'vnf', icon: '🤝', name: 'VN Foundation', color: '#FB923C', loc: 'Guayaquil', tz: 'America/Guayaquil', desc: 'Social foundation focused on education and community development.' },
  { key: 'premier', icon: '🏆', name: 'Premier', color: '#34D399', loc: 'Miami', tz: 'America/New_York', desc: 'Premium division for exclusive services and products.' },
  { key: 'ornella', icon: '🤖', name: 'Ornella IA', color: '#F87171', loc: 'Guayaquil', tz: 'America/Guayaquil', desc: 'Artificial intelligence and automation platform.' },
  { key: 'mentor', icon: '📚', name: 'Eminat Mentor', color: '#FBB040', loc: 'Guayaquil', tz: 'America/Guayaquil', desc: 'Educational platform for professional training and mentoring.' },
]
