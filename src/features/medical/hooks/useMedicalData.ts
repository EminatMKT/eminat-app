...
export function useMedicalData() {
  ...
  const { pacientes, pacienteFuentes, addPaciente: addPacienteDb, importarPacientes } = usePacientes()
  ...
  return {
    pacientes, pacienteFuentes, importarPacientes, citas, auditLogs, incidentes, trainings,
