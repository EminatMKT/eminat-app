...
// la consume tenga que escribir `as I18nKey`, que sería un `as` puesto sólo para callar al
// compilador (rules/codigo.md).
...
export function validarReunion(form: ReunionForm): I18nKey[] {
  ...
  if (!form.modalidad) errores.push('reuniones.error.modalidad')
