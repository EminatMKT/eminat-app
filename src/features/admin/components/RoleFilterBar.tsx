...
export default function RoleFilterBar({ busqueda, setBusqueda, filtroRol, setFiltroRol, action }: Props) {
  const { roles, adminUsuarios } = useApp()
  const { t } = useT()
  ...
  return (
    <ListToolbar busqueda={busqueda} setBusqueda={setBusqueda} action={action}>
