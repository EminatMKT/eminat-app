...
const billingRecordValues = { recordType, category, paymentStatus, currency }

/** The four closed vocabularies of a billing v2 record, each one declared once.
...
// along its settlement is, plus the one currency an amount is stored in. They are zod enums rather than plain arrays so that the option
