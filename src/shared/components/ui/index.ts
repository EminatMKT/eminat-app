...
//
// Cada componente es un archivo con UN `export default` —su carpeta ya dice cómo se llama— y acá
// se le pone el nombre público. El consumidor importa desestructurando:
//
//     import { Modal, Field, Button } from '@/shared/components/ui'
//
// Por qué el default adentro y el nombre acá: el default obliga a que el archivo declare UNA cosa
// —no hay dónde colgar la segunda—, y el barrel es el único lugar donde ese nombre se escribe, así
// que renombrar un componente es cambiar una línea y no buscar el string por todo el repo. Ver
// rules/codigo.md · "Un archivo exporta una cosa por default".
