...
// filas de una tabla del usuario. Lo demás sí se reusa: `VistaAcciones` y `GuardarVista`.
import { useT } from '@/shared/i18n'
import type { VistaFiltro } from '@/shared/data'
import GuardarVista from '../GuardarVista'
...
export default function FilterPresets(props: Props) {
  ...
  return (
    <div className={s.presets}>
      ...
      {activaId && <VistaAcciones vistaId={activaId} modificada={modificada} {...acciones} />}
      <GuardarVista onGuardar={onGuardar} />
    </div>
  )
}
