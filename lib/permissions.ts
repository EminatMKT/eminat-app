...
export const MODULE_META: Record<ModuleSlug, ModuleMeta> = {
  'stratix-mkt': {
    ...
    name: 'Stratix 360',
    href: '/stratix-mkt',
    description: 'Marketing, producción y campañas del holding.',
    iconKey: 'stratix-mkt',
  },
  cobranzas: {
    slug: 'cobranzas',
  ...
  directorio: {
    ...
    name: 'Directorio',
    href: '/directorio',
    description: 'Todo el equipo del holding en un lugar.',
    iconKey: 'directorio',
  },
  admin: {
    slug: 'admin',
...
export function moduleForPath(pathname: string): ModuleSlug | null {
  // Sort by prefix length desc so '/admin' wins over a hypothetical '/'.
